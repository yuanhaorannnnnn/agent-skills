...
class SkillsScanner:
    ...
    DESCRIPTIONS_ZH = {
        ...
        'restore-conversation': 'DEPRECATED — use Passdown for Canon task page based resume.',
        ...
        'save-conversation': 'DEPRECATED — use Sanitize for Canon task page updates.',
...
class CheatsheetGenerator:
    ...
    ICONS = {
        ...
        'comm': {'doc-coauthoring': '文档', 'internal-comms': '沟通', 'Sanitize': 'SAVE',
                 'Passdown': 'RESTORE', 'office-hours': 'YC', 'onboard': 'ONB',
    ...
    TRIGGER_HINTS = {
        ...
        'Sanitize': 'save conversation、store context、write recap',
        'Passdown': 'restore conversation、recover context、resume',
